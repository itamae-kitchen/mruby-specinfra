module Specinfra
  module Configuration
    class << self
      ...
      def os(value=nil)
        @os = value if value
        if @os.nil? && Object.const_defined?("RSpec") && RSpec.configuration.respond_to?(:os)
      ...
      def method_missing(meth, val=nil)
        ...
        begin
          if ! val.nil?
            ...
            RSpec.configuration.send(:"#{key}=", val) if Object.const_defined?("RSpec")
          end
          ...
          if ret.nil? && Object.const_defined?("RSpec") && RSpec.configuration.respond_to?(key)
